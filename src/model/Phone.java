...
public class Phone extends Product {
    ...
    public Phone(String productId, String productName, double price, int quantity, Brand brand,
                 int ram, int rom, int battery, double screenSize, String cpu, String color) {
    ...
    public String toString() {
        return String.format("[%s] %s | %s | %dGB/%dGB | %,d VND | %s | %.1f\" | %s",
                getProductId(),
                getProductName(),
